...
<%@ page import="com.commune.bean.*,com.commune.dao.*,java.util.*"%>
...
%>
  ...
  <%
  CommuneFileRequestDao dao=new CommuneFileRequestDao();
...
<body >
    ...
    <h2><font color=blue size="5">OwnerShip Request</font></h2>
    
  
<!--    <form action="./CategoryServlet" method="post">-->

<form action="./CommuneFileOwnerShipServlet">
