...
function validate() {
	...
	<body>
		...
		<center>
			<h3>
				<font color=green size="6">SOM REGISTER HERE</font>
			</h3>
			<form action="./RegistrationServlet"  name="myform" onsubmit="return validator();">
				<table>
					<tr>
						<td colspan="2" style="">
							<label
					...
					<tr>
						...
						<td>
							<input type="text" name="loginid" id="password"  class="input_text"
					...
					<tr>
						...
						<td>
							<input type="password" name="password" id="confirm_password" class="input_password" value="" placeholder="Create Password"
								required="">
							<label id="msgpass"
								style="color: red; font-size: 16px; font-style: italic;"></label>
						</td>
					...
					<tr>
						...
						<td>
							<input type="text" name="email" id="email" class="input_text" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" value="" placeholder="Enter EmailId" required>
							<label id="msgemail"
								style="color: red; font-size: 16px; font-style: italic;"></label>
