...
<th style="text-align: center;color: #99004d">Subject</th>
...
<%
  ...
  Connection con = dc.getConnection();
    ...
    PreparedStatement st1=con.prepareStatement("select t.FILEID,t.FILENAME,t.SUBJECT,t.FILESTATUS,r.LOGINID from FILES_TABLE t ,REQUEST r where  t.FILESTATUS=r.RSTATUS and t.FILENAME=r.FILENAME");
