...
function validate() {
	...
	<body>
		...
		<center>
			<h3>
				<font color=green size="6">Commune REGISTER HERE</font>
			</h3>
			<form action="./CommuneRegistrationServlet"  name="myform" onsubmit="return validator();">
				<table>
					<tr>
						<td colspan="2" style="">
							<label
	...
	<select id="role" name="role" required> 
     ...
     <option value="CUSER">CUSER</option> 
