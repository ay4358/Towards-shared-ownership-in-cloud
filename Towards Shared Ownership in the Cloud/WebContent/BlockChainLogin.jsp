...
<html>
  <head>
    ...
    <title>My JSP 'BlockChainLogin.jsp' starting page</title>
...
<div style="width: 1000px; height: auto; margin-top: -15px;">
			...
			<br/><br/>
			<h2><font color=green>BlockChain LOGIN HERE</font></h2>   
			<center>
			
		<form action="/BlockChainLoginServlet"  onsubmit="return validator();">
