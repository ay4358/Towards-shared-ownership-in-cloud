...
<%
  ...
  Connection con = dc.getConnection();
    ...
    PreparedStatement st1=con.prepareStatement("select LOGINID,DIRECTORY,FILENAME,USERSREQ,BCURID from BCUSERREQUEST where  BCUSTATUS='Grant'");
...
<td>
							 <a href="BCForwardRequest.jsp?id=<%=rs1.getInt(5)%>">Forward</a> 
						</td>
