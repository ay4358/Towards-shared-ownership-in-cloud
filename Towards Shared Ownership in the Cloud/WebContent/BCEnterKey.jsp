...
<div style="width: 1000px; height: auto; margin-top: -15px;">
		...
		<form action="./BCEnterKeyServlet"  onsubmit="return validator();">
                <table border="0"  style="" width="305px"  >   
                	...
                	<% String status=request.getParameter("status"); if(status!=null){out.println(status);} %></label>      
                        ...
                        <tr>
                         <td><input type="hidden" name="filename" id="uid" class="input_text"  value="<%=request.getParameter("filename")%>"/>
                         <label id="msguid"  style="color: red;font-size: 16px;font-style: italic;"></label>
                      
                        </td>
                        </tr>
                        <tr>
                         <td><input type="hidden" name="loginid" id="uid" class="input_text"  value="<%=request.getParameter("loginid")%>" />
                         <label id="msguid"  style="color: red;font-size: 16px;font-style: italic;"></label>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="filekey" id="uid" class="input_text"  value="" placeholder="Please Enter Valid key" autofocus/>
                         <label id="msguid"  style="color: red;font-size: 16px;font-style: italic;"></label>
