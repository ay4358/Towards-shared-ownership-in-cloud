...
<center>
		...
		<div style="width: 1000px; height: auto; margin-top: -15px;">
			...
			<%
				...
				%>
				<div style="margin-top: -5px;"><jsp:include page="CommuneAdminMenu.jsp"></jsp:include></div>
				<%
					}
					if (role.equals("CUSER")) {
				%>
				<div style="margin-top: -3px;"><jsp:include page="CommuneUserMenu.jsp"></jsp:include></div>
...
<form action="./CommuneChangePasswordServlet" ">
<br/>
<br/>
<br/>
					<table>
