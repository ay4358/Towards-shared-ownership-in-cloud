		...
		<div style="height: 300px;; width: 500px; background-color: #A9A9A9; margin: 20px;">
			<div style="height: 300px;; width: 500px; background-color: #A9A9A9; margin: 20px;">
					...
					<tr>
						...
						<td>
							 <a
								href="CommuneAcceptAccount.jsp?id=<%=pb.getLoginid()%>">accept account</a> 
						</td>
						
						<td>
							 <a
								href="CommuneRejectAccount.jsp?id=<%=pb.getLoginid()%>">Reject</a> 
						</td>
						<%--<td>
							 <a
								href="CommuneDeleteAccount.jsp?id=<%=pb.getLoginid()%>">Delete</a> 
						</td>
					--%></tr>
					<%
						}
