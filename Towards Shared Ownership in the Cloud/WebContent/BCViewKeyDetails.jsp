...
<%
  ...
  Connection con = dc.getConnection();
    ...
    PreparedStatement st1=con.prepareStatement("select br.BCURID,br.FILENAME,bu.FILEKEY,br.BCUSTATUS,br.LOGINID from BCFILEUPLOAD bu,BCUSERREQUEST br where  bu.LOGINID=br.LOGINID and bu.FILENAME=br.FILENAME and br.BCUSTATUS='Success'");
